...
RT_WEAK void onenet_upload_cycle(void)
{
...
rt_err_t onenet_mqtt_entry(void)
{
...
RT_WEAK rt_bool_t onenet_port_is_registed(void)
{

}

RT_WEAK rt_err_t onenet_port_get_register_info(char *dev_name, char *auth_info)
{

}

RT_WEAK rt_err_t onenet_port_get_device_info(char *dev_id, char *api_key, char *auth_info)
{
